...
const ScInputLabel = class {
    ...
    render() {
        ...
        return (h("label", { key: 'd6f4e489c05903a0b27266df9a22b5fe5ecd57f3', class: classNames(labelStyle, this.inputLabelClassName), htmlFor: 'searchcraft-input-id' }, this.label));
    }
};
