...
const SearchcraftInput = class {
    constructor(hostRef) {
        ...
        this.inputKeyUp = createEvent(this, "inputKeyUp", 7);
        this.customStyles = {};
        this.error = false;
        this.formClassName = '';
