...
const ScInput = class {
    ...
    render() {
        ...
        return (h("div", { key: '70f112d3912b663a747fae7e4b67249ef6d1e67d', class: classNames(containerClassName, this.formClassName, 'searchcraft-input-form') }, this.rightToLeftOrientation ? (h(Fragment, null, h("input", { class: classNames(this.error
                ? this.isLightTheme
                    ? 'inputErrorLightRTL'
                    : 'inputErrorDarkRTL'
                : this.isLightTheme
                    ? 'inputLightRTL'
                    : 'inputDarkRTL', inputClassName, 'searchcraft-input'), id: 'searchcraft-input-id', onChange: this.handleInputChange.bind(this), placeholder: this.placeholderValue, type: 'text', value: this.query }), this.inputCaptionValue && (h("sc-input-caption", { inputCaptionClassName: this.inputCaptionClassName, inputCaptionValue: this.inputCaptionValue, rightToLeftOrientation: this.rightToLeftOrientation })), this.query.length > 0 && (h("sc-clear-input-button", { onClearInput: this.handleClearInput, rightToLeftOrientation: this.rightToLeftOrientation })), h("sc-input-icon", { error: this.error, rightToLeftOrientation: this.rightToLeftOrientation }))) : (h(Fragment, null, h("sc-input-icon", { error: this.error, rightToLeftOrientation: this.rightToLeftOrientation }), h("input", { class: classNames(this.error
                ? this.isLightTheme
                    ? 'inputErrorLightLTR'
                    : 'inputErrorDarkLTR'
                : this.isLightTheme
                    ? 'inputLightLTR'
                    : 'inputDarkLTR', inputClassName, 'searchcraft-input'), id: 'searchcraft-input-id', onChange: this.handleInputChange.bind(this), placeholder: this.placeholderValue, type: 'text', value: this.query }), this.inputCaptionValue && (h("sc-input-caption", { inputCaptionClassName: this.inputCaptionClassName, inputCaptionValue: this.inputCaptionValue, rightToLeftOrientation: this.rightToLeftOrientation })), this.query.length > 0 && (h("sc-clear-input-button", { onClearInput: this.handleClearInput, rightToLeftOrientation: this.rightToLeftOrientation }))))));
    }
};
ScInput.style = scInputModuleCss;

export { ScInput as sc_input };

//# sourceMappingURL=sc-input.entry.js.map