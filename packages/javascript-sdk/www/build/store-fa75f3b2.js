...
var createStore_1 = vanilla$1.createStore = createStore;
...
'use strict';var l$1=Symbol.for("react.element"),n=Symbol.for("react.portal"),p$1=Symbol.for("react.fragment"),q=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),t=Symbol.for("react.provider"),u=Symbol.for("react.context"),v=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),z=Symbol.iterator;function A(a){if(null===a||"object"!==typeof a)return null;a=z&&a[z]||a["@@iterator"];return "function"===typeof a?a:null}
...
var Children = react_production_min.Children={map:S,forEach:function(a,b,e){S(a,function(){b.apply(this,arguments);},e);},count:function(a){var b=0;S(a,function(){b++;});return b},toArray:function(a){return S(a,function(a){return a})||[]},only:function(a){if(!O(a))throw Error("React.Children.only expected to receive a single React element child.");return a}};var Component = react_production_min.Component=E;var Fragment = react_production_min.Fragment=p$1;var Profiler = react_production_min.Profiler=r;var PureComponent = react_production_min.PureComponent=G;var StrictMode = react_production_min.StrictMode=q;var Suspense = react_production_min.Suspense=w;
...
var create_1 = react$2.create = create;
var useStore_1 = react$2.useStore = useStore;
...
var g = (o, t, e) => t in o ? d(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var l = (o, t, e) => g(o, typeof t != "symbol" ? t + "" : t, e);
class p {
  constructor(t) {
    l(this, "config");
    /**
    ...
    l(this, "search", async (t) => {
      ...
      try {
        const n = this.config.index.join(","), s = `${this.config.endpointURL}/index/${n}/search`, i = {
          query: this.buildQueryObject(t),
          limit: t.limit ?? 20
          // Default to 20 if not provided
        };
        t.offset !== void 0 && (i.offset = t.offset), t.facets && (i.facets = t.facets), t.order_by && (i.order_by = t.order_by, i.sort = t.sort === "desc" || t.sort === "asc" ? t.sort : "asc");
        const u = {
          method: "POST",
          headers: {
        ...
        if (!r.ok)
          throw new Error(
            `Error: ${r.statusText} (Status: ${r.status})`
          );
        return await r.json();
      } catch (n) {
  ...
  buildQueryObject(t) {
    ...
    if (t.yearsRange) {
      n = "must";
      const r = /* @__PURE__ */ new Date(`${t.yearsRange[0]}-01-01`), f = /* @__PURE__ */ new Date(`${t.yearsRange[1]}-12-31`);
      e.push({
        occur: n,
        normal: {
          ctx: `date_published:[${r.toISOString()} TO ${f.toISOString()}]`
        }
      });
    }
    console.log(Object.keys(((i = t == null ? void 0 : t.facets) == null ? void 0 : i.section.counts) || {}));
    const s = Object.keys(((u = t == null ? void 0 : t.facets) == null ? void 0 : u.section.counts) || {});
...
const useSearchcraftStore = zustand.create((set, get) => {
    let searchcraft = null;
...
//# sourceMappingURL=store-fa75f3b2.js.map