...
class SearchcraftErrorMessage {
    ...
    render() {
        return (hAsync("div", { key: '550a57c5ca8f42ba4550df5036f3edb87448d20f', class: 'searchcraft-error-message' }, hAsync("slot", { key: '766cb2c3ab9b4e2311aac0fcd7f0c352a0cfcdb7' }, "Search term is required.")));
    }
    static get cmpMeta() { return {
        "$flags$": 4,
  ...
  return w(this, void 0, void 0, function() {
    ...
    return y(this, function(e) {
      ...
      `, i = d.createShader(d.VERTEX_SHADER), a = d.createShader(d.FRAGMENT_SHADER);
              ...
              var _ = d.getAttribLocation(t, "position");
              d.enableVertexAttribArray(_), d.vertexAttribPointer(_, 2, d.FLOAT, !1, 0, 0), d.viewport(0, 0, p.width, p.height), d.clearColor(0, 0, 0, 1), d.clear(d.COLOR_BUFFER_BIT), d.drawArrays(d.LINES, 0, 2 * u);
...
class SearchcraftFacetList {
    ...
    render() {
        ...
        return (hAsync("div", { class: 'searchcraft-facet-list' }, !firstFacet && (hAsync("p", { class: 'searchcraft-facet-list-message' }, "Enter a search to view facets.")), firstFacet?.map((facetChild) => {
            const isChildSelected = facetChild.children
                ? facetChild.children?.some((child) => this.selectedPaths[child.path])
                : false;
            return (hAsync("div", { key: facetChild.path, class: 'searchcraft-facet-list-item' }, hAsync("label", { class: 'searchcraft-facet-list-checkbox-label' }, hAsync("input", { class: 'searchcraft-facet-list-checkbox-input', checked: this.selectedPaths[facetChild.path], onChange: (_event) => this.handleCheckboxChange(facetChild.path), type: 'checkbox' }), isChildSelected ? (hAsync("div", { class: 'searchcraft-facet-list-checkbox-input-dash-icon' }, hAsync("svg", { width: '14', height: '3', viewBox: '0 0 14 3', fill: 'none' }, hAsync("title", null, "Checkbox dash"), hAsync("line", { x1: '1.5', y1: '1.5', x2: '12.5', y2: '1.5', stroke: 'white', "stroke-width": '3', "stroke-linecap": 'round' })))) : (hAsync("div", { class: 'searchcraft-facet-list-checkbox-input-check-icon' }, hAsync("svg", { width: '16', height: '16', viewBox: '0 0 16 16', fill: 'none' }, hAsync("title", null, "Checkbox check"), hAsync("path", { d: 'M13.9999 2L5.74988 10L1.99988 6.36364', stroke: 'white', "stroke-width": '3', "stroke-linecap": 'round', "stroke-linejoin": 'round' })))), this.formatLabel(facetChild)), facetChild.children && facetChild.children.length > 0 && (hAsync(Fragment, null, facetChild.children.map((grandchild) => (hAsync("label", { key: grandchild.path, class: 'searchcraft-facet-list-checkbox-label searchcraft-facet-list-child-checkbox-label', style: {
                    display: this.selectedPaths[facetChild.path]
                        ? 'flex'
                        : 'none',
                } }, hAsync("input", { class: 'searchcraft-facet-list-checkbox-input searchcraft-facet-list-child-checkbox-input', checked: this.selectedPaths[grandchild.path], onChange: (_event) => {
                    this.handleCheckboxChange(grandchild.path);
                }, type: 'checkbox' }), hAsync("div", { class: 'searchcraft-facet-list-checkbox-input-check-icon searchcraft-facet-list-child-checkbox-input-check-icon' }, hAsync("svg", { width: '16', height: '16', viewBox: '0 0 16 16', fill: 'none' }, hAsync("title", null, "Checkbox check"), hAsync("path", { d: 'M13.9999 2L5.74988 10L1.99988 6.36364', stroke: 'white', "stroke-width": '3', "stroke-linecap": 'round', "stroke-linejoin": 'round' }))), this.formatSubLabel(grandchild, facetChild))))))));
        })));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftFilterPanel {
     ...
     */
    render() {
        return (hAsync("div", { key: '375f944a1aa6e3c65914154c14303aa0ccc189da', class: 'searchcraft-filter-panel' }, this.items.map((filterItem) => {
...
class SearchcraftInputForm {
    ...
    render() {
        ...
        return (hAsync("form", { key: 'f3a7f98391fcddbe2f569286ea8d83e4e92d94cb', class: 'searchcraft-input-form', onSubmit: this.handleFormSubmit }, hAsync("div", { key: '87d6ef227da093e2cb8de3122875c1953b08460c', class: inputGridClassNames, style: inputGridStyles }, hAsync("div", { key: 'f42ef7e60fe82d6c7722d6048127b08a64e90f4b', class: 'searchcraft-input-form-button' }, hAsync("searchcraft-button", { key: '7b409985dfa8c2408d28b2d4ca405a403ed5fd21', onButtonClick: this.handleFormSubmit, label: this.buttonLabel })), this.inputLabel && (hAsync("div", { key: '3cb4ffdf1348a14949cb974ef96a2f3eb324ca7a', class: 'searchcraft-input-form-label' }, hAsync("searchcraft-input-label", { key: '186ee1dddc5af7e56f9392629fdb18faabc4636d', label: this.inputLabel }))), this.error && (hAsync("div", { key: '79182d8f2a829df6b293fa102a43ef711270da0a', class: 'searchcraft-input-form-error-message' }, hAsync("searchcraft-error-message", { key: '1c5655590b6dbf5ed24c2a22be84dd0c9b7c8b12' }, "Something went wrong."))), hAsync("div", { key: '6e700e8ebaba6270dfbc99fbf2ea2552fe37105d', class: 'searchcraft-input-form-input-wrapper' }, hAsync("input", { key: '58e275e7c5ffbc04488879d9ea4d8a5819881418', autoComplete: 'off', class: 'searchcraft-input-form-input', onFocus: () => this.inputFocus?.emit(), onBlur: () => this.inputBlur?.emit(), onInput: (event) => {
                this.handleOnInput(event);
            }, placeholder: this.placeholderValue, type: 'text', value: this.inputValue }), hAsync("div", { key: 'eff5c36d76cfa077be729a7cb73e7cdcbbbfe5b8', class: 'searchcraft-input-form-input-icon' }, hAsync("svg", { key: 'ade52478c583196fc0cb8a37b47fe8fd6d800f22', class: 'searchcraft-input-form-input-search-icon', viewBox: '0 0 20 20', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', "aria-labelledby": 'searchcraft-title' }, hAsync("title", { key: 'b8d9fb19e459d2feecd6023773acfc7c24e9ac3f' }, "Search icon"), hAsync("path", { key: 'e68a6b38ba3c97c8c042aba54700e9fb8c5782f7', d: 'M17.5 17.5L13.875 13.875M15.8333 9.16667C15.8333 12.8486 12.8486 15.8333 9.16667 15.8333C5.48477 15.8333 2.5 12.8486 2.5 9.16667C2.5 5.48477 5.48477 2.5 9.16667 2.5C12.8486 2.5 15.8333 5.48477 15.8333 9.16667Z', stroke: 'currentColor', "stroke-width": '1.5', "stroke-linecap": 'round', "stroke-linejoin": 'round' }))), isShowingClearButton && (hAsync("button", { key: 'c1805b0fe02d648a88f869c2581f431f815abc31', type: 'button', class: 'searchcraft-input-form-clear-button', onClick: this.handleClearInput }, hAsync("svg", { key: '81d89da16dd8e0f88911b172d3bf06b6071c4bbd', class: 'searchcraft-input-form-clear-button-icon', viewBox: '0 0 22 22', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', "aria-labelledby": 'icon-title' }, hAsync("title", { key: '2e996056f4cf4fcf0ecb2a75723eb27e9b305c81' }, "Clear icon"), hAsync("path", { key: '12f3e08904bf53f7772616c321842edac4ab36e3', d: 'M14 8L8 14M8 8L14 14M21 11C21 16.5228 16.5228 21 11 21C5.47715 21 1 16.5228 1 11C1 5.47715 5.47715 1 11 1C16.5228 1 21 5.47715 21 11Z', stroke: 'currentColor', "stroke-width": '1.5', "stroke-linecap": 'round', "stroke-linejoin": 'round' }))))))));
    }
...
class SearchcraftInputLabel {
    ...
    label = '';
    render() {
        return (hAsync("label", { key: '68bdf4b5a4469bd931d942d5f21414c2cb514e6e', class: classNames('searchcraft-input-label', this.inputLabelClassName), htmlFor: 'searchcraft-input-id' }, this.label));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftPopoverButton {
    ...
    render() {
        return (hAsync("button", { key: '483d53567d059ef388c8080b7bba908005ff7a6b', class: 'searchcraft-popover-button', onClick: this.handleOnClick.bind(this), type: 'button' }, hAsync("slot", { key: '1209500adc910879cbe7f9d7b3c393a3a5f1023e' })));
    }
    static get cmpMeta() { return {
        "$flags$": 4,
...
class SearchcraftPopoverForm {
    ...
    focusOnNextListItem(direction) {
        const listItems = Array.from(document.querySelectorAll('a.searchcraft-popover-form-list-item')).filter((el) => !el.hasAttribute('disabled') && el.offsetParent !== null);
    ...
    renderInlinePopover() {
        ...
        return (hAsync("div", { class: popoverFormClassNames }, hAsync("searchcraft-input-form", { onInputFocus: this.handleInputFocus.bind(this) }), isListViewVisible && (hAsync("div", { class: 'searchcraft-popover-form-inline-wrapper-outer' }, hAsync("div", { class: 'searchcraft-popover-form-inline-wrapper-inner' }, hAsync("searchcraft-popover-list-view", { popoverResultMappings: this.popoverResultMappings, searchClientResponseItems: this.searchClientResponseItems, adClientResponseItems: this.adClientResponseItems, searchResultsPage: this.searchResultsPage, searchResultsPerPage: this.searchResultsPerPage }))))));
    }
    renderModalPopover() {
        if (this.isPopoverVisibleInState) {
            ...
            return (hAsync("div", { class: 'searchcraft-popover-form-modal' }, hAsync("div", { class: 'searchcraft-popover-form-modal-backdrop', onClick: this.handleModalBackdropClick }), hAsync("div", { class: 'searchcraft-popover-form-modal-inner' }, hAsync("div", { class: popoverFormClassNames }, hAsync("div", { class: 'searchcraft-popover-form-input-wrapper searchcraft-popover-form-modal-input-wrapper' }, hAsync("searchcraft-input-form", { onInputFocus: this.handleInputFocus.bind(this), onInputInit: this.handleInputInit.bind(this) }), hAsync("button", { type: 'button', class: 'searchcraft-popover-form-button searchcraft-popover-form-modal-button', onClick: this.handleCancelButtonClick.bind(this) }, "Cancel")), this.hasResultsToShow && (hAsync("searchcraft-popover-list-view", { popoverResultMappings: this.popoverResultMappings, searchClientResponseItems: this.searchClientResponseItems, adClientResponseItems: this.adClientResponseItems, searchResultsPage: this.searchResultsPage, searchResultsPerPage: this.searchResultsPerPage }))))));
        }
    }
    renderFullscreenPopover() {
        if (this.isPopoverVisibleInState) {
            return (hAsync("div", { class: 'searchcraft-popover-form-fullscreen' }, hAsync("div", { class: 'searchcraft-popover-form' }, hAsync("div", { class: 'searchcraft-popover-form-input-wrapper searchcraft-popover-form-fullscreen-input-wrapper' }, hAsync("searchcraft-input-form", { onInputFocus: this.handleInputFocus.bind(this), onInputInit: this.handleInputInit.bind(this) }), hAsync("button", { type: 'button', class: 'searchcraft-popover-form-button searchcraft-popover-form-fullscreen-button', onClick: this.handleCancelButtonClick.bind(this) }, "Cancel")), this.hasResultsToShow && (hAsync("searchcraft-popover-list-view", { popoverResultMappings: this.popoverResultMappings, searchClientResponseItems: this.searchClientResponseItems, adClientResponseItems: this.adClientResponseItems, searchResultsPage: this.searchResultsPage, searchResultsPerPage: this.searchResultsPerPage })))));
        }
    }
    render() {
        switch (this.type) {
...
class SearchcraftPopoverListItem {
    ...
    render() {
        return (hAsync("a", { key: '680cba7625c4d049695fc96c842e538a00ac1a8e', class: 'searchcraft-popover-list-item', href: this.href, onClick: this.handleLinkClick.bind(this) }, this.imageSrc && (hAsync("div", { key: 'c15600485002982fa95cfc0dda47a1b8af11d927', class: 'searchcraft-popover-list-item-image-wrapper' }, hAsync("img", { key: 'ad34cc7d2d364cab85814b3e3461def84d17cc2e', alt: this.imageAlt, src: this.imageSrc, class: 'searchcraft-popover-list-item-image' }))), hAsync("div", { key: '9fbabde7039cec0d28737250ebaaee582ede565a', class: 'searchcraft-popover-list-item-info-wrapper' }, hAsync("p", { key: '9728f5a1a5ceb13b286d8f6e0a63b0b6488f2e2d', class: 'searchcraft-popover-list-item-title' }, this.titleContent), hAsync("p", { key: 'a09dae452140d957f160530333179d53e16b5a80', class: 'searchcraft-popover-list-item-subtitle' }, this.subtitleContent))));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftPopoverListItemAd {
    ...
    renderCustomAd() {
        ...
        return (hAsync("div", { class: 'searchcraft-custom-ad', id: containerId, "data-searchcraft-ad-container-id": this.adContainerId, innerHTML: containerInnerHTML }));
    }
    renderNativoAd() {
    ...
    static get cmpMeta() { return {
        ...
        "$members$": {
            ...
            "adContainerId": [1, "ad-container-id"],
            "searchTerm": [32],
...
class SearchcraftPopoverListView {
    ...
    renderWithCustomAds() {
        ...
        for (let n = 0; n < adStartQuantity; n++) {
            itemsToRender.push(hAsync("searchcraft-ad", { adSource: 'Custom', adContainerId: nanoid(), key: `${n}-ad` }));
        }
        ...
        searchItems.forEach((item, index) => {
            if (interstitialInterval &&
                ...
                for (let n = 0; n < interstitialQuantity; n++) {
                    itemsToRender.push(hAsync("searchcraft-ad", { adSource: 'Custom', adContainerId: nanoid(), key: `${item.id}-ad-${n}` }));
                }
            }
    ...
    renderWithNativoAds() {
        ...
        // Renders ads at beginning
        for (let n = 0; n < adStartQuantity; n++) {
            itemsToRender.push(hAsync("searchcraft-ad", { adSource: 'Nativo', adContainerId: nanoid(), key: `${n}-ad` }));
        }
        // Renders search results + interstitial ads
        searchItems.forEach((item, index) => {
            if (interstitialInterval &&
                ...
                index >= interstitialInterval) {
                for (let n = 0; n < interstitialQuantity; n++) {
                    itemsToRender.push(hAsync("searchcraft-ad", { adSource: 'Nativo', adContainerId: nanoid(), key: `${item.id}-ad-${n}` }));
                }
            }
            itemsToRender.push(hAsync("searchcraft-popover-list-item", { item: item, key: item.id, popoverResultMappings: this.popoverResultMappings, documentPosition: this.searchResultsPerPage * (this.searchResultsPage - 1) + index }));
        });
...
class SearchcraftSearchResult {
    ...
    render() {
        ...
        if (typeof this.template === 'undefined') {
            return (hAsync("div", { class: 'searchcraft-search-result searchcraft-search-result-no-template' }, Object.entries(this.item.document).map(([key, value]) => (hAsync("p", { key: key }, hAsync("strong", null, key), ": ", value)))));
        }
        return (hAsync("div", { class: 'searchcraft-search-result', innerHTML: this.templateHtml }));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftSearchResults {
    ...
    renderWithADMAds() {
        return (hAsync("div", { class: 'searchcraft-search-results' }, this.adClientResponseItems?.map((item) => (hAsync("searchcraft-ad", { adSource: 'adMarketplace', adClientResponseItem: item, adContainerId: nanoid(), key: item.id }))), this.searchClientResponseItems?.map((item, index) => (hAsync("searchcraft-search-result", { key: item.id, "document-position": this.searchResultsPerPage * (this.searchResultsPage - 1) + index, index: index, item: item, template: this.template })))));
    }
    renderWithCustomAds() {
        const itemsToRender = [];
        const interstitialInterval = this.config?.customAdInterstitialInterval || 0;
        ...
        searchItems.forEach((item, index) => {
            ...
            itemsToRender.push(hAsync("searchcraft-search-result", { key: item.id, "document-position": this.searchResultsPerPage * (this.searchResultsPage - 1) + index, index: index, item: item, template: this.template }));
        });
        // Renders ads at end
        for (let n = 0; n < adEndQuantity; n++) {
            itemsToRender.push(hAsync("searchcraft-ad", { adSource: 'Custom', adContainerId: nanoid(), key: `${n}-ad` }));
    ...
    renderWithNoAds() {
        return (hAsync("div", { class: 'searchcraft-search-results' }, this.searchClientResponseItems?.map((item, index) => (hAsync("searchcraft-search-result", { key: item.id, "document-position": this.searchResultsPerPage * (this.searchResultsPage - 1) + index, index: index, item: item, template: this.template })))));
    }
    render() {
...
class SearchcraftSelect {
    ...
    render() {
        return (hAsync("div", { key: 'e0c5df6af7511b75f3f1edbaf73a8beec3312865', class: 'searchcraft-select' }, this.label && (hAsync("label", { key: '1ca9daf53e9843277e1c8e9076fe7064729712cb', class: 'searchcraft-select-label', id: this.labelId || `${this.inputId}-label`, htmlFor: this.inputId }, this.label)), hAsync("div", { key: '16f0fb4a5c4df91552eae35cf780702ab69d36f3', class: 'searchcraft-select-input-wrapper' }, hAsync("select", { key: '8dfe968effdd77b42910f622eeef7d9f0d135b7c', "aria-labelledby": this.label ? this.labelId || `${this.inputId}-label` : undefined, class: 'searchcraft-select-input', disabled: this.disabled, id: this.inputId, name: this.name, onChange: this.handleSelectChange }, (typeof this.options === 'string'
            ? JSON.parse(this.options)
            : this.options).map(({ label, value, selected }) => {
            return (hAsync("option", { key: value, value: value, selected: selected }, label));
        })), hAsync("svg", { key: '5448b9ccae4cd50790deacf540410b7231d13639', class: 'searchcraft-select-input-icon', width: '20', height: '20', viewBox: '0 0 20 20', fill: 'none', xmlns: 'http://www.w3.org/2000/svg' }, hAsync("title", { key: 'ea5769d103c471541f0b40645bc8a30ac1258b48' }, "Select dropdown icon"), hAsync("path", { key: '08ad78a637ff2ac975765b5f2937746e34e8d9c9', d: 'M5 7.5L10 12.5L15 7.5', stroke: 'currentColor', "stroke-width": '1.5', "stroke-linecap": 'round', "stroke-linejoin": 'round' }))), this.caption && (hAsync("p", { key: '1e0eab4d5ba1d8a04207bb291949cc6f9c526350', class: 'searchcraft-select-caption' }, this.caption))));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftSlider {
    ...
    render() {
        ...
        return (hAsync("div", { key: '7c4a8a7ec8b1d37947c01b9940408b5dbf1fd0a7', class: 'searchcraft-slider' }, hAsync("div", { key: '94020c3ac52b1ba8b2a73a4287222ac514e737d5', class: 'searchcraft-slider-range' }, hAsync("div", { key: 'c59c572f3654dae0ec5235bd1b526e78fd6a2960', class: 'searchcraft-slider-active-range', style: {
                left: `${startPercent}%`,
                width: `${endPercent - startPercent}%`,
            } }), hAsync("input", { key: '876c49b6bda7856af53f37067e3249ea7ef6dc98', class: classNames('searchcraft-slider-input', 'searchcraft-slider-input-min-handle'), max: this.max, min: this.min, onInput: this.handleStartValueChange.bind(this), step: this.granularity, style: { zIndex: this.lastFocusedHandle === 'min' ? '2' : '1' }, type: 'range', value: this.startValue }), hAsync("input", { key: '794300de53914e7760cb36e4e0674ea37d5dbfb2', class: classNames('searchcraft-slider-input', 'searchcraft-slider-input-max-handle'), max: this.max, min: this.min, onInput: this.handleEndValueChange.bind(this), step: this.granularity, style: { zIndex: this.lastFocusedHandle === 'max' ? '2' : '1' }, type: 'range', value: this.endValue })), hAsync("div", { key: '890dbdc982d363876a0165bc94b56473285c7c20', class: 'searchcraft-slider-label' }, hAsync("span", { key: '8bafb2cb98f5b28c347ce5a8da4dd5c36ef3ffca', class: 'searchcraft-slider-start-label' }, startLabel), hAsync("span", { key: '44ae039bdf006e603ce6f5b353fc08e67c20fa88', class: 'searchcraft-slider-end-label' }, endLabel))));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftToggleButton {
    ...
    render() {
        return (hAsync("div", { key: '7cb49f11b6104a50e91a33d18e05945b775e17e6', class: classNames('searchcraft-toggle-button', {
                'searchcraft-toggle-button-active': this.isActive,
            }) }, hAsync("div", { key: '1e2c8a23be7f2a2bae42aa12a0654e1b2cbbd92f' }, hAsync("p", { key: '6c2612c7f7a2cd9f0e174277822344300525e7b6', class: 'searchcraft-toggle-button-label' }, this.label), this.subLabel && (hAsync("p", { key: 'c2fc84f854689f59097c8a0d1063503de47a452d', class: 'searchcraft-toggle-button-sub-label' }, this.subLabel))), hAsync("button", { key: 'b2d921686d2d65453733aecdfe3ce885ec8caeac', class: 'searchcraft-toggle-button-background', onClick: this.handleToggle, type: 'button' }, hAsync("div", { key: '10d5364af5bd54ca4db3340f34abcdb417b98efe', class: 'searchcraft-toggle-button-handle' }))));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
